...
\author[UNAL]{Research Team\\\small Universidad Nacional de Colombia}
...
\input{sections/02-clinical-problem}
\input{sections/03-imaging}
\input{sections/04-anatomy-geometry}
\input{sections/05-hypothesis}
\input{sections/06-pipeline-overview}
\input{sections/07-sam-propagation}
\input{sections/08-direction-aware}
\input{sections/09-feature1-sphere}
\input{sections/10-feature2-circles}
\input{sections/11-geometric-trick}
\input{sections/12-multivendor}
\input{sections/13-results}
