...
Cuando la igualdad falla hay que salir del grupo de similaridades. El grupo \Ot{}, formado
por las matrices $M$ con $M^{\mathsf T} \eta M = \eta$ y $\eta = \mathrm{diag}(1,1,1,-1)$, preserva la
...
\midrule
\textbf{completa} & n/a & \textbf{10.50 mm} & 1.000 & \textbf{2.18} \\
\bottomrule
\end{tabular}
\end{center}
...
se puede afirmar que haga falta \Ot.} La maquinaria hay que construirla igual, porque el
enunciado la pide y el caso general la necesita, pero la conclusión honesta es que la violación
